...
// Fetch items for Electronics category (assume Category_ID = 4)
$category_id = 4;
...
<div class="navbar">
    ...
    <a href="Asetion2.php">Water Bottle</a>
    ...
    <?php while ($item = $items->fetch_assoc()): ?>
        <div class="item-detail">
            ...
            <div class="item-header">
                ...
                <p class="item-category">Category: Others</p>
            </div>
