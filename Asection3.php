...
// Fetch items for Electronics category (assume Category_ID = 3)
$category_id = 3;
...
<head>
    <meta charset="UTF-8">
    <title>Stationary Section</title>
    <style>
       /* Page styling */
...
<div class="navbar">
    <a href="Asection1.php">Electronic</a>
    <a href="Asection2.php">Water Bottle</a>
    ...
    <?php while ($item = $items->fetch_assoc()): ?>
        <div class="item-detail">
            ...
            <div class="item-header">
                ...
                <p class="item-category">Category: Stationary</p>
            </div>
